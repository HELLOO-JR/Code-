...
local function CreateGUI()
    ...
    local menuWidth = math.min(400, viewportX * 0.8)
    local menuHeight = math.min(500, viewportY * 0.8)
    ...
    if target then
        ...
        if bonePos then
            if Settings.Aimbot.Mode == "Rage" then
                local targetCF = CFrame.lookAt(Camera.CFrame.Position, bonePos)
...
StarterGui:SetCore("SendNotification", {
    ...
    Text = "Script loaded! Press RightShift or click ☰ to toggle.",
    Duration = 5
})